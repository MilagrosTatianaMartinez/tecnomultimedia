...
String[]textos3={"Bolita saltadora :D/","Muevete de izquierda a derecha y consigue un puntajede 7 \n ¡No dejes que la bolita se caiga! :O"};
String[]textos4= {"FELICIDADES ¡GANASTE :D!", "Muchas gracias por jugar"};
